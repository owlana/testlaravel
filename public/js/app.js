...
var forms = Array.from(document.querySelectorAll('.j-form'));

if (forms.length) {
  forms.forEach(function (item) {
    var form = new _components_form__WEBPACK_IMPORTED_MODULE_0__["default"]();
    form.init({
      target: item
    });
  });
...
function () {
  ...
  _createClass(Form, [{
    ...
    key: "_subscribes",
    value: function _subscribes() {
      var _this2 = this;

      observer.subscribe('inputValidate', function (input) {
        _this2._changeState(input);
      });
    }
    /**
    ...
    value: function _send() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(this.action, this.formData).then(function (response) {
        var status = response.data.status;

        if (status) {
          _this3._sendIsSuccess();
        } else {
    ...
    key: "_changeState",
    value: function _changeState(input) {
    ...
    key: "_sendIsSuccess",
    value: function _sendIsSuccess() {
      _utils__WEBPACK_IMPORTED_MODULE_2__["default"].hide(this.errorMessageWrap);
    ...
    key: "_showSuccessMessage",
    value: function _showSuccessMessage() {
      _utils__WEBPACK_IMPORTED_MODULE_2__["default"].show(this.successMessageWrap);
      _utils__WEBPACK_IMPORTED_MODULE_2__["default"].hide(this.form);
    ...
    value: function _showErrorMessage() {
      _utils__WEBPACK_IMPORTED_MODULE_2__["default"].show(this.errorMessageWrap);
      _utils__WEBPACK_IMPORTED_MODULE_2__["default"].hide(this.form);
    }
    /**
    ...
    value: function validateAll() {
      ...
      this.inputs.forEach(function (item) {
        if (!item.checkValidity()) {
          _this4.errorValidate.innerHTML += item.name + ' - ' + item.validationMessage + '<br>';
          validate = false;
        }
      });
      return validate;
...
function () {
  ...
  _createClass(Utils, null, [{
    ...
    value: function isInViewport(element) {
      ...
      var belowViewport = 0;
      var verticalInView = top <= windowHeight && top + rect.height >= belowViewport;
      var horizontalInView = left <= windowWidth && left + rect.width >= belowViewport;
    ...
    key: "bodyFixed",
    value: function bodyFixed(element) {
      Object(body_scroll_lock__WEBPACK_IMPORTED_MODULE_1__["disableBodyScroll"])(element, {
    ...
    key: "replaceSpace",
    value: function replaceSpace(str) {
    ...
    key: "convertToDigit",
    value: function convertToDigit(value) {
    ...
    key: "convertToRank",
    value: function convertToRank(value, denominator) {
    ...
    value: function toCamelCase(string) {
      ...
      var dashRegEx = /\-([a-z])/ig;
      return string.replace(dashRegEx, function (m, letter) {
    ...
    key: "getDataSet",
    value: function getDataSet(element) {
      var _this = this;

      var attributes = Array.from(element.attributes); // eslint-disable-next-line no-useless-escape

      var dataRegEx = /^data\-(.+)/;
      var dataset = {};
      var first = 1;
      attributes.forEach(function (item) {
        var match = item.name.match(dataRegEx);

        if (match) {
          dataset[_this.toCamelCase(match[first])] = item.value;
        }
      });
      return dataset;
    }
    ...
    key: "pluralWord",
    value: function pluralWord(n, words) {
      /* eslint-disable  */
    ...
    value: function setUrlParams(params) {
      ...
      window.history.pushState(null, null, "?".concat(query.toString()));
    }
    /**
    ...
    key: "getUrlParams",
    value: function getUrlParams(param) {
      var get = window.location.search;
      var url = new URLSearchParams(get);
    ...
    key: "isBreakpoint",
    value: function isBreakpoint(min, max) {
...
__webpack_require__(/*! C:\OS\OSPanel\domains\testlaravel\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\OS\OSPanel\domains\testlaravel\resources\sass\app.scss */"./resources/sass/app.scss");
